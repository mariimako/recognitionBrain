...
class Signin extends React.Component { // smart componenet, extends app
    constructor(props) {
        super(props);
        this.state = {
            signInEmail: '',
            ...
            <article className="br3 b--black-10 ba mv4 w-100 w-50-m w-25-l mw5 shadow-5 center">
                <main className="pa4 black-80">
                    <form className="measure">
                        ...
                        <div className="">
                        <input 
                            onClick = {this.onSubmitSignIn} // arrow function allows to run only when clicked, not when rendered
